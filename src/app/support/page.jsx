...
const SupportPage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start pt-10 bg-bg px-4 bg-[#a6f2da]">
      <div className="w-full max-w-lg mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold text-surface mb-6 text-center">Support Channels</h1>
