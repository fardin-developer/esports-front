  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto bg- p-8 rounded-lg shadow-lg text-gray-200 text-justify">
        ...
        <p className="mb-4">
          Zennova’s website is displayed in various languages for the purposes of enhancing user experience and interaction. Save as otherwise expressly stated, the use and display of any particular language or translation are purely to enhance user experience and shall not in any way be interpreted that Zennova is targeting or operating specifically in any particular country. Zennova operates on the world wide web and caters to the language needs of its users internationally.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Access, tamper with, or use other Zennova users’ accounts.</li>
        ...
        <p className="mb-4">
          ZENNOVA DOES NOT REPRESENT OR GUARANTEE THAT THE PRODUCT WILL BE FREE FROM LOSS, CORRUPTION, ATTACK, VIRUSES, INTERFERENCE, HACKING, OR OTHER SECURITY INTRUSION, AND ZENNOVA DISCLAIMS ANY LIABILITY RELATING THERETO.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          You agree to indemnify, defend, and hold Zennova, its affiliates, and their respective officers, directors, employees, agents, licensors, representatives, partners, and third-party providers harmless from and against any and all claims, demands, losses, expenses, damages, and costs, including but not limited to attorneys’ fees, relating to or arising from: (a) your use of the Product and/or website; (b) any violation of these Terms and Conditions by you; (c) any action taken by Zennova as part of its investigation of a suspected violation of these Terms and Conditions or as a result of its finding or decision that a violation of these Terms and Conditions has occurred; or (d) any violation of any rights of another by you. This means that you cannot sue Zennova, its affiliates, and their respective officers, directors, employees, agents, licensors, representatives, partners, and third-party providers as a result of its decision to remove or refuse to process any information or Content, to warn you, to suspend or terminate your access to the Product, or to take any other action during the investigation of a suspected violation or as a result of Zennova’s conclusion that a violation of these Terms and Conditions has occurred.
        </p>
        <p className="mb-4">
          This waiver and indemnity provision apply to all violations described in or contemplated by these Terms and Conditions. This obligation shall survive the termination or expiration of these Terms and Conditions and/or your use of the Product. You acknowledge that you are responsible for all use of the Product using your account, and that these Terms and Conditions apply to any and all usage of your account. You agree to comply with these Terms and Conditions and to defend, indemnify, and hold Zennova harmless from and against any and all claims and demands arising from usage of your Account, whether or not such usage is expressly authorized by you.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Governing Law & Jurisdiction</h2>
        <p className="mb-4">
          Notwithstanding from where you gain or attempt to gain access to this Website and/or the products herein, you agree that these Terms and Conditions, your performance and conduct under it, your access to this Website and use of the products herein, content, and any disputes arising thereunder shall, at all times, be governed by and construed in accordance with the laws of India without regard to its conflicts-of-law provisions, and you and Zennova agree to submit to the exclusive jurisdiction of the courts of Gurugram, Haryana, India.
        </p>
