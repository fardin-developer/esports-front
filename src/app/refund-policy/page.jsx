...
const RefundPolicy = () => {
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 text-gray-700  bg-yellow-300">
      <Head>
        <title>CP TopUp Refund & Return Policy</title>
        <meta name="description" content="CP TopUp Refund and Return Policy" />
      </Head>
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="mb-4">
          At <strong>CP TopUp.in</strong>, operated by <strong>ONESTEPLINK (OPC) PRIVATE LIMITED</strong>, we are committed to delivering a seamless and reliable top-up experience for all our users. Our return and refund policy outlines the conditions under which refunds may be provided for failed transactions.
        </p>
