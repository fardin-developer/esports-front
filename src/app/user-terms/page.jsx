...
const UserTermsAndConditions = () => {
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-yellow-300">
      <Head>
        <title>User Terms and Conditions - CP TopUp</title>
        <meta name="description" content="CP TopUp Technologies Private Limited User Terms and Conditions" />
      </Head>
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg text-gray-700 text-justify">
        ...
        <p className="mb-4">
          This web page represents our terms and conditions ("Terms") pertaining to the access and use of our website
          located at www.CP TopUp.in (“Website”), mobile application, and/or any other portal (collectively “Platform”)
          provided by CP TopUp Technologies Private Limited and/or its affiliates.
        </p>
        <p className="mb-4">
          The Terms govern all products, services, and other offerings (collectively, “Products”) made available to you
          by CP TopUp Technologies Private Limited, a company incorporated under the laws of India, with its registered
          office at C/O: Uda Ram Mali, Tekrawas, Khara kua ke paas, Bhinmal, Jalore, Rajasthan – 343029, India, and its
          affiliates (“CP TopUp”), through the Platform.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          The terms, "we" and "our" as used here shall refer to CP TopUp. Our Products permit you to make purchases at our Platform using your account or through other prescribed payment channels.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          You will be solely responsible for the accuracy, completeness, and correctness of the information provided by you to CP TopUp. If any liability arises on us due to the incorrectness or incompleteness of the information provided by you, you shall defend, indemnify, and hold harmless CP TopUp from any and all claims, damages, losses, or expenses, including reasonable attorneys' fees, arising out of the incorrectness or incompleteness of the information provided by you. In any event, CP TopUp shall not bear any manner of liability or be responsible in any manner whatsoever in this regard.
        </p>
        <p className="mb-4">
          You expressly understand and agree that CP TopUp shall not be liable for any direct, indirect, incidental, special, consequential, or exemplary damages, or damages for loss of profits, goodwill, use, data, or other intangible losses resulting from the use of or inability to use the Product and/or Platform.
        </p>
        <p className="mb-4">
          In no event shall CP TopUp or our merchants be liable for lost profits or any special, incidental, or consequential damages arising out of or in connection with our Platform, our Product, or these Terms (however arising, including negligence). You agree to indemnify and hold us and (as applicable) our parent, subsidiaries, affiliates, officers, directors, agents, and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your breach of these Terms or the documents it incorporates by reference, or your violation of any law or the rights of a third party or your use of the Product and/or our Platform.
        </p>
        <p className="mb-4">
          The Product and the Platform may provide, or third parties may provide, links to other World Wide Web (www) sites or resources. As CP TopUp has no control over such websites and resources, you acknowledge and accept that CP TopUp is not responsible for the availability of such external websites or resources, and does not endorse and is not responsible or liable for any information, data, text, software, music, sound, photographs, graphics, video, messages, tags, or other materials ("Content"), advertising, products, or other materials on or available from such websites or resources. As such, you also acknowledge and accept that CP TopUp does not and is not obligated to examine, evaluate, or screen any of these external resources and does not warrant or endorse any of the information, content, offers, or claims of these third parties. You further acknowledge and agree that CP TopUp shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such Content, goods available on or through any such website or resource.
        </p>
        <p className="mb-4">
          You agree not to alter, modify, reproduce, duplicate, copy, sell, resell, or exploit any portion of the Product, use of the Product, or access to the Product without the express written permission by CP TopUp.
        </p>
        <p className="mb-4">
          The entire contents of our Platform, which consists of, inter alia, text, video (of any format, streaming or otherwise), audio clips (of any format, streaming or otherwise), data assemblages, graphics, logos, buttons, icons, and any software ("Platform Content") is proprietary to CP TopUp or its licensors and is protected under international and domestic copyright laws. The arrangement and/or compilation of the Platform Content is proprietary to CP TopUp and is protected under international and domestic copyright laws.
        </p>
        <p className="mb-4">
          Verbal or written abuse of any kind (including but not limited to threats of abuse or retribution and defamatory statements) of any CP TopUp customer, employee, member, or officer will result in immediate account termination.
        </p>
        <p className="mb-4">
          The failure of CP TopUp to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision.
        </p>
        <p className="mb-4">
          The Platform is displayed in various languages for the purposes of enhancing user experience and interaction. Save as otherwise expressly stated, the use and display of any particular language or translation are purely to enhance user experience and shall not in any way be interpreted that CP TopUp is targeting or operating specifically in any particular country. CP TopUp operates on the world wide web and caters to the language needs of its users internationally. If there exists any conflict between the English version of the Platform and the other versions, the English version shall prevail.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>Transactions made via CP TopUp cannot be refuted once initiated.</li>
          <li>You are solely responsible for the usage of your mobile account or payment channel, and CP TopUp shall have no liability to you or any third party for any unauthorized use or access of CP TopUp through your mobile account or payment channels or in the event your mobile account or your account has been compromised. In such circumstances, it is your responsibility to inform your mobile operator or your payment channel of such instances.</li>
          <li>Any taxes, duties, currency exchange fees, data charges, and any other applicable charges in relation to your purchases via CP TopUp shall be borne by you.</li>
          <li>CP TopUp, or your mobile operator if a purchase is made via your mobile account or your chosen payment channel provided at www.CP TopUp.in, has the sole discretion to accept or decline a transaction performed by you through CP TopUp for whatsoever reason, and that, should this occur, CP TopUp shall not be held liable to you.</li>
          <li>You have consented to be contacted by CP TopUp, and to receive notices electronically, including but not limited to by text message, from us. You agree that we may make any notices that we may be required by law to make in electronic format. These communications will be deemed to be in writing and received by you when sent to you.</li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Disparage, tarnish, or otherwise harm CP TopUp, our Platforms, or our Product.</li>
        ...
        <p className="mb-4">
          CP TopUp reserves the right to deny payments from suspicious buyers. In the event that an order or payment is tagged as being suspicious, delivery of item(s) will be delayed until CP TopUp can successfully verify its legitimacy, be it by phone or a request for verifying information. The determination of what amounts to suspiciousness shall be at the sole and absolute discretion of CP TopUp. You acknowledge and accept that under the laws of certain jurisdictions, CP TopUp may be obligated to report any suspicious transactions to the relevant authorities.
        </p>
        <p className="mb-4">
          Unless you notify CP TopUp to the contrary on the day of delivery and such notification is confirmed by email, the Product shall be deemed to have been accepted by you as being in good order and in accordance with the terms hereof and any other terms specific to such Product, if any.
        </p>
        <p className="mb-4">
          You undertake to make all payments promptly and in accordance with any rules, regulations, or guidelines issued by CP TopUp from time to time and shall not be entitled to withhold payment of all or any of the price.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Points are acquired for every purchase of CP TopUp Products made by using the payment channels provided on the Platform.
        </p>
        <p className="mb-4">
          To acquire Points, you must perform a transaction purchase on the Platform.
        </p>
        <p className="mb-4">
          Points will then be automatically added to your CP TopUp membership Account no later than 24 hours after the transaction has been initiated.
        </p>
        <p className="mb-4">
          You will acquire Points for every transaction that is performed at CP TopUp with the term of 0.01% of the transaction value. CP TopUp reserves the right to change the provision at any time.
        </p>
        ...
        <p className="mb-4">
          We have the absolute discretion to alter the Terms, in any way in respect of the Program, including terms of ordering, Point usage procedures for Reward, or Reward in any form, without prior notice, and even if the changes can affect the value of the accumulated Points. You must check our present Terms and details and other information for the Program through the Member Web Portal or by calling our Customer Support at cs@CP TopUp.in.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          From time to time, our Product may be delayed, interrupted, or disrupted for an indeterminate period of time. In addition, except as otherwise required by applicable law or regulation, CP TopUp may terminate your use of Product or impose limits on the type and/or amount of transactions you are allowed to make with the Product at any time at its sole discretion without prior notice. CP TopUp and its affiliates shall not be liable for any claim arising from or related to CP TopUp arising from any such delay, interruption, disruption, limitation, or suspension.
        </p>
        ...
        <p className="mb-4">
          TO THE EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL THE AGGREGATE LIABILITY OF CP TopUp OR OUR AFFILIATES (AND OUR AND THEIR RESPECTIVE EMPLOYEES, DIRECTORS, AGENTS, AND REPRESENTATIVES), PARTNERS, AND LICENSORS ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR THE TRANSACTIONS CONTEMPLATED HEREBY, WHETHER IN CONTRACT, TORT (INCLUDING NEGLIGENCE, PRODUCT LIABILITY, OR OTHER THEORY), WARRANTY, OR OTHERWISE, EXCEED THE AMOUNT OF FEES EARNED BY US IN CONNECTION WITH YOUR USE OF PRODUCT AND/OR PLATFORM DURING THE THREE (3) MONTH PERIOD IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO THE CLAIM FOR LIABILITY.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">No Refund Policy</h2>
        <p className="mb-4">
          CP TopUp digital Products have a strict no-refund policy. Please be sure the products are right for you before purchasing. Users are solely responsible for confirming that their devices are compatible with the Products they purchase. All virtual items purchased are final, non-refundable, and non-returnable. We do not offer refunds or exchanges for the incorrect purchase of Products, including due to compatibility issues.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Termination</h2>
        <p className="mb-4">
          CP TopUp may at any time, under certain circumstances and without prior notice, immediately terminate or suspend all or a portion of your Account and/or access to the Product. Cause for such termination shall include: (a) violations of provisions hereof or any other policies or guidelines that are referenced herein and/or posted on the Product; (b) a request by you to cancel or terminate your Account; (c) a request and/or order from law enforcement, a judicial body, or other government agency; (d) where provision of the Product to you is or may become unlawful; (e) unexpected technical or security issues or problems; (f) your participation in fraudulent or illegal activities; or (g) failure to pay any fees owed by you in relation to the Product, provided that in the case of non-material breach, CP TopUp will be permitted to terminate only after giving you 30 days’ notice and only if you have not cured the breach within such 30-day period. Any such termination or suspension shall be made by CP TopUp in its sole discretion and CP TopUp will not be responsible to you or any third party for any damages that may result or arise out of such termination or suspension of your Account and/or access to the Product.
        </p>
        <p className="mb-4">
          In addition, CP TopUp may terminate your Account upon 30 days’ prior notice via email to the address associated with your Account if (a) your Account has been inactive for one (1) year; or (b) there is a general discontinuance of the Product or any part thereof. Notice of general discontinuance of Product will be provided as set forth herein, unless it would not be reasonable to do so due to circumstances arising from legal, regulatory, or governmental action; to address user security, user privacy, or technical integrity concerns; to avoid disruptions to other users; or due to a natural disaster, a catastrophic event, war, or other similar occurrence outside of CP TopUp’s reasonable control.
        </p>
        <p className="mb-4">
          Should you breach any of these Terms, CP TopUp shall have the exclusive sole and absolute right to terminate, discontinue, or withdraw the provision of the Product to you. In the event of a breach by you, CP TopUp reserves its right to pursue any remedy or relief in so far as permitted by law, which includes but is not limited to injunction, damages, and/or specific performance.
        </p>
        ...
        <p className="mb-4">
          CP TopUp is not a bank, e-money issuer, or money transferor and does not require the approval of the relevant Authorities to operate. Your prepaid or post-paid mobile account is not a bank account, e-money account, payment card, or other regulated financial instrument. CP TopUp does not process or store your credit or debit card number.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Nothing in these Terms is intended to or creates any type of joint venture, employee-employer, creditor-debtor, escrow, partnership, or any fiduciary relationship between you, us, or our affiliates. CP TopUp may assign the Terms (or a portion thereof), and any of CP TopUp’s obligations, in whole or in part, at any time, with or without notice to you, but you may not assign these Terms, or any part of it, to any other party without CP TopUp’s prior written approval. Any attempt by you to do so is void.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          These Terms constitute the entire agreement between you and CP TopUp, and supersede and cancel all prior and contemporaneous agreements, claims, representations, and understandings (including, but not limited to, any prior versions of the Terms). No modification or amendment of the provisions contained herein will be binding on CP TopUp unless set forth in writing signed by us.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          <strong>Via Email:</strong> cpstore255@gmail.com
        </p>
        <p className="mb-4">
          <strong>Address:</strong> CP TopUp<br />
          C/O: Uda Ram Mali, Tekrawas, Khara kua ke paas, Bhinmal, Jalore, Rajasthan – 343029, India
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Grievance Redressal</h2>
        <p className="mb-4">
          For any complaints or concerns, you may contact our Nodal Grievance Redressal Officer as required under the
          Information Technology Act, 2000 and rules made thereunder:
        </p>
        <p className="mb-4">
          <strong>NAME:</strong> Mr. Ibne Alam Khan<br />
          <strong>Address:</strong> C/O: Uda Ram Mali, Tekrawas, Khara kua ke paas, Bhinmal, Jalore, Rajasthan – 343029,
          India<br />
          <strong>TEL:</strong> +91 9923575712<br />
          <strong>EMAIL:</strong> cpstore255@gmail.com
        </p>
      </div>
    </div>
  );
