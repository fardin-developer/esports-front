                ...
                {!isLoggedIn ? (
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="relative group">
                      <button className="flex items-center space-x-2 px-3 py-2 rounded-full bg-[rgba(100,255,218,0.08)] border border-[rgba(100,255,218,0.2)] hover:border-[rgba(100,255,218,0.4)] transition-all duration-300">
                      ...
                      {/* Dropdown Menu */}
                      <div className="absolute right-0 mt-2 w-48 bg-[rgba(15,15,35,0.98)] backdrop-blur-xl border border-[rgba(100,255,218,0.2)] rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10">
                        <div className="py-2">
                          <Link
                            href="/profile"
                            className="block px-4 py-2 text-sm text-white/90 hover:text-[#64ffda] hover:bg-[rgba(100,255,218,0.05)] transition-colors"
                          >
                            Profile
                          </Link>
                          <Link
                          ...
                          <div className="border-t border-[rgba(100,255,218,0.1)] my-1"></div>
                          <button
                            onClick={handleLogout}
                            className="block w-full text-left px-4 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-[rgba(255,0,0,0.05)] transition-colors"
                          >
                            Logout
                          </button>
                        </div>
