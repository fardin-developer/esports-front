...
const AboutUs = () => {
  return (
    <div className="min-h-screen text-gray-700 py-12 px-4 sm:px-6 lg:px-8 text-justify bg-yellow-300">
      <Head>
        <title>About Us - CP TopUp</title>
        <meta name="description" content="Learn more about CP TopUp Technologies Private Limited, our mission, and our commitment to innovation." />
      </Head>
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-center">About CP TopUp</h1>
  ...
  Zeonnova.in is a premier gaming top‑up platform in India, empowering players with instant, secure access to in‑game currencies such as UC, Diamonds, Coins, and digital vouchers. Our streamlined system ensures a seamless top‑up experience for gamers across all their favorite titles.
        ...
        <p className="mb-4">
          Operated by <strong>ONESTEPLINK (OPC) PRIVATE LIMITED</strong> (CIN:{' '}
          <strong>U82990AS2023OPC025559</strong>), we are registered at:
        </p>
        ...
        <p className="mb-4">
          At CP TopUp, we understand the importance of your privacy. We are committed to safeguarding your personal information in accordance with our Privacy Policy and applicable laws, including the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011. For more details, please review our <a href="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</a>.
        </p>
        ...
        <p className="mb-4">
          ...
          <strong>Address:</strong> C/O: Uda Ram Mali, Tekrawas, Khara kua ke paas,
          Bhinmal, Jalore, Rajasthan – 343029, India<br />
